...
function getColors() {
	return [["Green", "#008000"], ["Black", "#000000"], ["Red", "#ff0000"], ["Yellow", "#ffff00"], ["Grey", "#808080"]]
}
...
$(function() {
	...
	// $('#product_variant_color_id').css('background-color', $('#product_variant_color_id').find('option:selected').val())	
	...
	$('#product_variant_color_id').change(function(){ 
		console.log(this)
		var size = $('#product_variant_size_id option:selected').text()
		var colors = $(this).filter('optgroup[label=' + size + ']').html()
		$(this).html(colors)
	})
