...
$(document).ready(function() {
  ...
  var queryParams = window.location.href.split('?').splice(1, 4);
  ...
  //   var currentParams = queryParams.toString().split('&');
...
(function() {
  jQuery(function() {
    ...
    return $('#product_variant_size_id').change(function() {
      size = $('#product_variant_size_id :selected').text();
      options = $(colors).filter("optgroup[label='" + size + "']").html();
      return $('#product_variant_color_id').html(options);
    });
  });
