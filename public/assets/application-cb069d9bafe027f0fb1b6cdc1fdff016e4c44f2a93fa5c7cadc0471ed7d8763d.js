...
$(function() {
	$('#discount-button').click(function(event) {
		...
		$(this).fadeOut(350, function() {
			$('#discount').append('<div class="form-group"><label for="product_Popust">Popust</label><input min="0" max="99" step="any" value="0" class="form-control" type="number" name="product[discount]" id="product_discount"></div>')
		})	
	})
})
;
