...
$(function() {
	$('#discount-button').click(function(event) {
		...
		$(this).fadeOut(350, function() {
			$('#discount').html('<div class="form-group"><label for="product_Popust">Popust</label><input min="1" max="99" class="form-control" type="number" name="product[discount]" id="product_discount"></div>')
		})	
	})
})
;
